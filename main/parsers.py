...
def create_parser():
    ...
    list_domains_parser.add_argument('--passive', nargs='+',choices=['crtsh', 'subfinder', 'wayback', 'assetfinder', 'rappiddns', 'abuseipdb', 'shodan' ,'all'], help='passive enumeration')
    list_domains_parser.add_argument('--dnsbrute', nargs='+',choices=['4char', 'assetnote', 'chaos', 'jhaddix', 'nokovo', 'all'], help='dns brute force')
    ...
    list_subdomains_parser.add_argument('--resolve', action='store_true', help='Resolve subdomains')
    list_subdomains_parser.add_argument('--permutation', action='store_true', help='Permutation on subdomains')
    ...
    list_url_parser.add_argument('--scan', nargs='+',choices=['nuclei', 'all'], help='Scanning')
    ...
    list_ips_parser.add_argument('--scan', nargs='+',choices=['nuclei', 'all'], help='Scanning')
    ...
    import_parser = sub_parser.add_parser('import', help='Import database [scopes directory]')
    import_parser.add_argument('directory', help='directory of exported database')
    
    export_parser = sub_parser.add_parser('export', help='Export database [scopes directory]')
    
    convert_parser = sub_parser.add_parser('convert', help='Convert files')
    convert_action_parser = convert_parser.add_argument_group('conversion options')
    convert_action_parser.add_argument('format', choices=['csv', 'xml'], help='Output format [csv, xml]')
    convert_action_parser.add_argument('input', help='Input JSON or BSON file')
    convert_action_parser.add_argument('output', help='Output file (CSV or XML)')
