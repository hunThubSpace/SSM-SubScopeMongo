...
from commands import (
    add_program, list_programs, delete_program, add_domain, list_domains, delete_domain, add_subdomain, list_subdomains,
    delete_subdomain, add_url, list_urls, delete_url, add_ip, list_ip, delete_ip
)
